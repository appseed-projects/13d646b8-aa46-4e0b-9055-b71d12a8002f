...
- Timestamp: `2022-06-06 05:50`
- Build ID: `13d646b8-aa46-4e0b-9055-b71d12a8002f`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/13d646b8-aa46-4e0b-9055-b71d12a8002f.git
$ cd 13d646b8-aa46-4e0b-9055-b71d12a8002f
```
